...
export function ParticleField({
  ...
  const {
    ...
    intensity: { value: 0.095, min: 0.005, max: 1, step: 0.005 },
    stableColor: "#8aa896",
    crisisColor: "#d06030",
    Shimmer: folder({
      shimmerSpikeFreq: { value: 1.7, min: 0, max: 20, step: 0.1, label: "spike freq" },
      shimmerSpikeAmp: { value: 4.5, min: 0, max: 10, step: 0.05, label: "spike amp" },
      shimmerSharpness: { value: 32.5, min: 1, max: 60, step: 0.5, label: "spike sharpness" },
      shimmerSlowFreq: { value: 0.4, min: 0, max: 5, step: 0.05, label: "slow freq" },
      shimmerSlowAmp: { value: 0.15, min: 0, max: 1, step: 0.01, label: "slow amp" },
      shimmerDepth: { value: 1.0, min: 0, max: 1, step: 0.01, label: "depth" },
    }),
    "Node bulge": folder({
      nodeRadius: { value: 0.37, min: 0.05, max: 3, step: 0.01, label: "radius" },
      nodeEmphRadius: { value: 0.42, min: 0.05, max: 4, step: 0.01, label: "focus radius" },
      nodeBulgeSize: { value: 0.1, min: 0, max: 15, step: 0.1, label: "size boost" },
    ...
    Glints: folder({
      glintRatio: { value: 0.08, min: 0, max: 1, step: 0.01, label: "ratio" },
      glintSizeMult: { value: 1.8, min: 1, max: 8, step: 0.1, label: "size mult" },
      glintIntensity: { value: 5.0, min: 1, max: 30, step: 0.1, label: "intensity" },
